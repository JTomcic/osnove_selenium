...
public class SwagLabTests extends BasicTestSwag {
    ...
    public void verifyIfTheRemoveButtonIsWorking() {
        ...
        cartPage.clickOnRemoveCartItemBtn();

        cartPage.waitForCartItemBeInvisible();
    }

    @Test(priority = 33, retryAnalyzer = SwagLabsRetry.class)
    public void verifyIfTheContinueButtonIsPresented() {
        String username = "standard_user";
        String password = "secret_sauce";
        ...
        Assert.assertTrue(
                cartPage.doesContinueShoppingBtnExist(),
                "Cart Continue Shopping button should be visible");
    }

    @Test(priority = 34, retryAnalyzer = SwagLabsRetry.class)
    public void verifyIfTheContinueButtonIsWorking() {
        String username = "standard_user";
        String password = "secret_sauce";
        ...
        Assert.assertEquals(
                driver.getCurrentUrl(),
                baseUrl + "/inventory.html",
                "Should be redirected to inventory page after click on Continue Shopping button.");
    }
